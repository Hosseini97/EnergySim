    ...
    def state(self) -> SystemState:
        ...
        return SystemState(
            thermal=ThermalState(
                room_temp=self._thermal.room_temp, 
                wall_temp=self._thermal.wall_temp,
                mass_temp=self._thermal.mass_temp # <-- This is the change
            ),
